        ...
        public static void AddLog( string Message, string stack, DotNetNuke.Entities.Modules.PortalModuleBase Module, System.Web.SessionState.HttpSessionState SS)
        {
            ...
            if (SS != null)
            {
                ...
                for (int a = 0; a < SS.Count; a++)
                {
                    ...
                    if (SS[a] != null)
                    {
                        serializationtype = SS[a].GetType().Name;
                    }
                    else
                    {
                        serializationtype = "NULL OBJECT";
                    }
                    ...
                    {
                        LI.AddProperty("From session Nro. " + a.ToString() + " and key " + "NULL KEY" + " type [" + serializationtype + "] ", serialization);
                    }
