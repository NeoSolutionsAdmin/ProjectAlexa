...
namespace ConnectionDispensario.Conexiones
{
    public class Con_Historial
    {
        ...
        public DataRow GetDiagnostico_By_Id(int ID)
        {
            DispensarioACDataSet.Select_Diagnostico_By_IdDataTable DT = new DispensarioACDataSet.Select_Diagnostico_By_IdDataTable();
            DispensarioACDataSetTableAdapters.Select_Diagnostico_By_IdTableAdapter TA = new DispensarioACDataSetTableAdapters.Select_Diagnostico_By_IdTableAdapter();
