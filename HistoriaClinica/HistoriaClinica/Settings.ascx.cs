...
namespace Christoc.Modules.HistoriaClinica
{
    ...
    /// 
    /// Because the control inherits from HistoriaClinicaSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : HistoriaClinicaModuleSettingsBase
    {
